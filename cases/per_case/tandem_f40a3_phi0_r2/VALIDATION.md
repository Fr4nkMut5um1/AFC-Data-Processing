...
```matlab
run_review_smoke_for_case(pwd, '原件解压目录/fixtures/controlled', ...
...
S5正式raw本case应核对 15 张PNG及对应FIG、CSV；ZIP只有原PNG/部分CSV，无正式S5 MAT/FIG。formal postproc图组为单独未完成项，不能由smoke补齐。
