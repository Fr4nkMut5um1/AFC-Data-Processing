...
entries = dir(fullfile(test_case.TestData.repo_root, '*_case.m'));
verifyEqual(test_case, numel(entries), 1);
files = {fullfile(test_case.TestData.repo_root, entries(1).name)};
for i = 1:numel(files)
